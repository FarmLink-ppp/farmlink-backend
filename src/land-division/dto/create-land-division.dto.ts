...
export class CreateLandDivisionDto {
  @ApiProperty({
    example: 'North Plot',
    description: 'Name of the land division',
  })
  @IsString()
  @IsNotEmpty()
  name: string;
  ...
  @ApiProperty({
    example: 1.5,
    description: 'Area size of the land division in hectares/acres',
  })
  @IsNumber()
  area: number;
  ...
  @ApiProperty({
    ...
    description: 'GPS coordinates of the land division',
  })
  @IsString()
  @IsNotEmpty()
  geolocation: string;
  ...
  @ApiPropertyOptional({
    example: 2,
    description: 'ID of the associated plant (if any)',
  })
  @IsOptional()
  @IsInt()
